...
int main (int argc, char **argv)
{
    ...
    bool evolve_p1 = atoi(argv[2]);
    bool evolve_i = atoi(argv[3]);
    bool evolve_t = atoi(argv[4]);
    ...
    gsl_vector *x_selgrad = gsl_vector_alloc(9);
    ...
    for (iter = 0; iter < max_iter ; ++iter)
    {
        ...
        if (condition_p11 && condition_p21 && condition_p20 && condition_p10 &&
